...
# 33 Розділ 4: Кампанії в MITRE ATT&CK Framework

## Що таке кампанія?

**Кампанія** — це активність вторгнення, яка проводиться протягом певного періоду часу з спільними цілями та об'єктами атаки.

### Ключові характеристики кампаній:

🔍 **Важливо розуміти:** Не кожен успішний злом підприємства є кампанією!

Навіть якщо організація зазнала серйозної атаки з ransomware, що призвела до мільйонних збитків, це **не обов'язково** є кампанією, оскільки не відповідає критеріям.

### Критерії кампанії:
- ⏰ **Специфічний період часу**
- 🎯 **Спільні цілі та об'єкти**
- 🏢 **Зазвичай множинні цілі** (рідко одне підприємство)
- 🌐 **Організовані операції** на великому рівні

### Хто проводить кампанії?

Кампанії зазвичай проводяться:
- 🏛️ **Акторами національних держав** (Nation State Actors)
- 🏴‍☠️ **Добре організованими злочинними групами**

---

## Приклади відомих кампаній

### 1. Атака на електромережу України 2016 року (ID: C0025)

**🔥 Threat Actor:** Sandworm Team

**📅 Період:** 2016 рік (друга велика атака після 2015 року)

**🎯 Мета:** Порушення роботи української енергосистеми

**⚡ Особливості:**
- Використання кількох TTP (Tactics, Techniques, Procedures)
- Атака на критично важливу інфраструктуру
- Значний резонанс у безпековій спільноті
- Продовження попередньої кампанії 2015 року

**💡 Чому це важливо:** Демонструє можливості кібератак на критичну інфраструктуру

### 2. Операція "Cuckoo Bees"

**🕵️ Тип:** Кампанія кібершпигунства

**📅 Період:** З 2019 року (як мінімум)

**🌍 Географія цілей:**
- Виробничі компанії Східної Азії
- Підприємства Західної Європи  
- Організації Північної Америки

**🎯 Основні цілі:**
- 📋 Крадіжка пропрієтарної інформації
- 🔬 Викрадення документів R&D (досліджень і розробок)
- 💻 Отримання вихідного коду
- 📐 Викрадення креслень різних технологій
...
**🏭 Суть:** Промислове шпигунство та збирання інтелектуальної власності

---

## Ключові відмінності кампаній

### ❌ НЕ є кампанією:
- Одиночна атака на підприємство
- Несистематична злочинна активність
- Спонтанні кібератаки без координації

### ✅ Є кампанією:
- Координовані операції
- Множинні цілі з спільними характеристиками
- Тривала активність у часі
- Чіткі стратегічні цілі
- Участь організованих груп
...
- 🔍 **Аналіз патернів** атак у різних організаціях
- 🧩 **Зв'язування інцидентів** в єдину картину загроз
- 📊 **Прогнозування** майбутніх цілей
- 🛡️ **Розробка захисту** проти конкретних кампаній

### Для організацій:
- 📈 **Оцінка ризиків** відповідно до активних кампаній
- 🚨 **Підвищення пильності** при виявленні ознак відомих кампаній
- 🤝 **Співпраця** з іншими організаціями для обміну threat intelligence
- 🔒 **Адаптація захисту** під специфічні TTP кампаній

---

## Висновки

🎯 **Головне розуміння:** Кампанії — це **оркестровані операції**, а не індивідуальні атаки на організації.

**Запам'ятайте:**
- Кампанії вимагають координації та планування
- Зазвичай мають геополітичні або економічні мотиви
- Проводяться протягом тривалого періоду
- Включають множинні цілі та методи атак

**💡 Практична порада:** При аналізі інцидентів безпеки завжди розглядайте можливість того, що атака може бути частиною більшої кампанії. Це допоможе краще зрозуміти мотиви зловмисників та підготуватися до можливих подальших атак.

---

*У наступних розділах ми детально розглянемо групи Winnti та APT41, які були учасниками кампанії "Cuckoo Bees".*

--------------------------------------------------------------------------------------------------------------

# 34  Розділ 5: Взаємозв'язки між компонентами MITRE ATT&CK Framework

## Загальна схема взаємодії

Тепер, коли ми визначили всі важливі терміни в контексті MITRE ATT&CK, розглянемо детальніше, як вони пов'язані між собою та взаємодіють.

---

## Сторона зловмисників (Adversary Side)

### 🏴‍☠️ Групи (Groups) — центральний елемент

**Групи є основою всієї діяльності зловмисників і мають:**

#### 🎯 **Тактики (Tactics)**
- Відповідають на питання: **"НАВІЩО?"** група робить певні дії
- Визначають цілі та мотивації групи
- Приклади: Initial Access, Persistence, Privilege Escalation

#### 💻 **Програмне забезпечення (Software)**
- Інструменти, які використовує група
- **Приклади:**
  - Exploit tools (наприклад, Mimikatz)
  - Backdoors та RAT'и
  - Custom malware

#### ⚙️ **Техніки та підтехніки (Techniques & Sub-techniques)**
- Відповідають на питання: **"ЯК?"** група здійснює атаки
- Конкретні методи виконання тактик
...
```
ГРУПИ → мають → ТАКТИКИ (НАВІЩО?)
   ↓
використовують → ПРОГРАМНЕ ЗАБЕЗПЕЧЕННЯ
   ↓
що дозволяє → ТЕХНІКИ та ПІДТЕХНІКИ (ЯК?)
   ↓
які виконують → ТАКТИКИ (досягають цілей)
```

### 📋 Детальна схема взаємодії:

| Компонент | Функція | Питання | Приклад |
|-----------|---------|---------|---------|
| **Групи** | Організація атак | Хто? | APT28, Lazarus Group |
| **Тактики** | Цілі атаки | Навіщо? | Persistence, Exfiltration |
| **Техніки** | Методи виконання | Як? | Spearphishing, Registry Modification |
| **Програмне забезпечення** | Інструменти | Чим? | Mimikatz, Cobalt Strike |
| **Підтехніки** | Специфічні методи | Як саме? | Spearphishing Link vs Attachment |

---

## 🚀 Формування кампаній

### Коли окремі атаки стають кампанією?

**Кампанія** формується коли діяльність групи має:

✅ **Структурованість та орхестрацію**
- Координовані дії протягом часу
- Чіткий план виконання

✅ **Цільовий характер**
- Специфічні цілі та об'єкти атак
- Стратегічні мотивації

✅ **Консистентність методів**
- Однакові тактики, техніки та підтехніки
- Подібні мотивації та цілі

✅ **Тимчасові рамки**
- Діяльність протягом певного періоду
- Послідовність атак

### 🔄 Приклад формування кампанії:

```
Група Sandworm
    ↓
Тактика: Impact (порушення критичної інфраструктури)
    ↓
Техніки: Drive-by Compromise, Lateral Movement
    ↓
Програмне забезпечення: BlackEnergy, KillDisk
    ↓
= Кампанія: Атаки на українську енергосистему (2015, 2016)
```

---

## Сторона захисників (Defender Side)

### 🛡️ Система виявлення загроз

#### 📊 **Джерела даних (Data Sources)**
- Основа для побудови системи виявлення
- **Приклади:**
  - Логи системи безпеки
  - Мережевий трафік
  - Поведінка процесів
  - Файлові операції

#### 🔍 **Детекції (Detections)**
- Побудовані на основі джерел даних
- **Мета:** Виявлення діяльності зловмисників

### 🎯 Взаємозв'язок захисту та нападу:

```
ТЕХНІКИ ТА ПІДТЕХНІКИ (зловмисники)
    ↕️ (протидіють)
ДЕТЕКЦІЇ (захисники)
    ↑
базуються на
...
## Практичний приклад повного циклу

### 🔴 Сценарій атаки:

**1. Група:** APT29 (Cozy Bear)
- **Мотивація:** Державне шпигунство
- **Цілі:** Урядові та дипломатичні установи

**2. Тактики:**
- Initial Access (початковий доступ)
- Persistence (закріплення)
- Collection (збирання даних)
...
**3. Результат:**
- Виявлення спроб атаки
- Блокування зловмисної активності

---

## Ключові принципи взаємозв'язків

### 🧩 Принцип ієрархії:
```
Кампанії (найвищий рівень)
    ↓
Групи
    ↓
Тактики → Техніки → Підтехніки
    ↓
Програмне забезпечення (інструменти)
```

### ⚡ Принцип взаємозалежності:
- **Групи** не можуть діяти без **тактик**
- **Тактики** реалізуються через **техніки**
- **Техніки** потребують **програмного забезпечення**
- **Детекції** неможливі без **джерел даних**

### 🔄 Принцип зворотного зв'язку:
- Захисники аналізують техніки → покращують детекції
- Зловмисники адаптуються → розробляють нові методи
- Постійна еволюція з обох сторін
...
**1. Системний підхід:**
- Всі компоненти MITRE ATT&CK взаємопов'язані
- Неможливо розглядати елементи ізольовано

**2. Питання та відповіді:**
- **Тактики:** "Навіщо?" (мотивація)
- **Техніки:** "Як?" (методи)
- **Групи:** "Хто?" (виконавці)
- **Програмне забезпечення:** "Чим?" (інструменти)

**3. Захист через розуміння:**
- Розуміння зв'язків допомагає будувати ефективну оборону
- Джерела даних → детекції → протидія техніками

### 🎯 Практичні рекомендації:

**Для аналітиків:**
- Вивчайте зв'язки між групами та їх TTP
- Аналізуйте кампанії як цілісні операції
- Використовуйте MITRE ATT&CK для картування загроз

**Для інженерів безпеки:**
- Забезпечте джерела даних для критичних технік
- Розробляйте детекції на основі TTP груп
- Моніторьте активні кампанії у вашому секторі

---

*Розуміння цих взаємозв'язків є фундаментом для ефективного використання MITRE ATT&CK Framework в практичній діяльності з кібербезпеки.*


------------------------------------------------------------------------------------------------------------------------------------------------


# 35 Розділ 6: Практична робота з веб-інтерфейсом MITRE ATT&CK

## Вступ до практичної роботи

Після вивчення теоретичних основ MITRE ATT&CK Framework, настав час познайомитися з практичним використанням фреймворку через його веб-інтерфейс.

🌐 **Офіційний сайт:** [attack.mitre.org](https://attack.mitre.org)

---

## Огляд головної сторінки

### 📊 Матриці ATT&CK

При відкритті сайту ви побачите **Enterprise Matrix** — це матриця за замовчуванням, яка є найбільш використовуваною.

#### Доступні матриці:
- **🏢 Enterprise** — корпоративні середовища (за замовчуванням)
- **📱 Mobile** — мобільні пристрої 
- **🏭 ICS (Industrial Control Systems)** — промислові системи управління

### 🗂️ Основні розділи навігації:
- **Tactics** — тактики
- **Techniques** — техніки
- **Defenses** — захист
- **CTI (Cyber Threat Intelligence)** — розвідувальна інформація
- **Resources** — додаткові ресурси

---

## Структура Enterprise Matrix

### 📋 Макет матриці:

**Стовпці:** 14 тактик (Reconnaissance, Initial Access, Execution тощо)

**Рядки:** Техніки та підтехніки, згруповані під відповідними тактиками

### 🔍 Робота з підтехніками:

**За замовчуванням підтехніки приховані** для кращої читабельності.

#### Способи перегляду підтехнік:
1. **Розкрити конкретну техніку:** клік на кнопку розгортання
2. **Показати всі підтехніки:** кнопка "Show all sub-techniques"

**⚠️ Важливо:** В ATT&CK понад 400 підтехнік, тому повний перегляд може бути складним для сприйняття.

### 📊 Порівняння матриць:

| Матриця | Кількість тактик | Особливості |
|---------|------------------|-------------|
| **Enterprise** | 14 | Найповніша, основна |
| **Mobile** | Менше | Спрощена версія |
| **ICS** | Найменше | Мінімалістична |

**💡 Примітка:** Існує значне перекриття між матрицями, оскільки багато TTP є технологічно-агностичними.

---

## Детальний перегляд тактик

### 🎯 Навігація до тактик:

**Шлях 1:** Пряме натискання на тактику в матриці
**Шлях 2:** Меню "Tactics" → "Enterprise" → Список всіх 14 тактик

### 📄 Інформація про тактику:

Для кожної тактики ви побачите:
- **📝 Опис** — що робить ця тактика
- **🆔 ID** — унікальний ідентифікатор
- **📅 Дати** — створення та остання модифікація
- **⚙️ Техніки** — список пов'язаних технік

**Приклад:** Тактика Reconnaissance
- Містить техніки: Active Scanning, Gather Victim Identity Info тощо
...
**Метод 1:** З перегляду тактики
**Метод 2:** Меню "Techniques" → "Enterprise" → Повний список

### 📋 Структура техніки:

**Основна інформація:**
- **🆔 Унікальний ID** (наприклад, T1595)
- **📅 Дати створення/модифікації**  
- **🎯 Пов'язана тактика**
- **📝 Детальний опис**

**Ключові розділи:**
- **🛡️ Mitigations** — способи пом'якшення
- **🔍 Detections** — методи виявлення
- **📚 References** — посилання на додаткові джерела

### 🔬 Підтехніки:

**Приклад: Active Scanning (T1595)**
- **T1595.001** — Scanning IP Blocks
- **T1595.002** — Vulnerability Scanning  
- **T1595.003** — Wordlist Scanning

**Особливості підтехнік:**
- Власні ID
- Індивідуальні описи
- Можуть мати різні mitigations/detections
- **🔗 Процедури** — зв'язки з реальними кампаніями

---

## Підхід "Defense First"

### 📊 Джерела даних (Data Sources)

**Загальна кількість:** 41 джерело даних

**Особливості:**
- **🎯 Загальний характер** — вказують напрямок, не конкретику
- **📈 Масштабованість** — одне джерело покриває багато сервісів

#### Приклад: Cloud Service
**Компоненти:**
...
```
Загальне джерело: Cloud Service
    ↓
Конкретизація: AWS, Azure, GCP
    ↓
Специфічні логи: CloudTrail, Activity Log, Cloud Audit
```

### 🛡️ Засоби пом'якшення (Mitigations)

**Загальна кількість:** 43 засоби пом'якшення

**Принцип роботи:**
- **📋 Загальні рекомендації** на високому рівні
- **🎯 Напрямки для деталізації**
- **🔧 Основа для конкретних налаштувань**

#### Приклади засобів:
- **Antivirus/Anti-malware** — загальна рекомендація
- **User Training** — навчання користувачів
- **Network Intrusion Prevention** — мережевий захист

#### 📚 Популярні бенчмарки для деталізації:
- **CIS Benchmark** — Center for Internet Security
- **Microsoft Cloud Security Benchmark** — для Azure
- **AWS Security Best Practices** — для Amazon

### 🏭 Активи ICS (Assets)

**Призначення:** Пристрої та системи промислового контролю

**Приклад: PLC (Programmable Logic Controller)**
- Опис пристрою
- Техніки атак на PLC  
- Специфічні загрози для промисловості

---

## Cyber Threat Intelligence (CTI)

### 👥 Групи зловмисників (Groups)

**База даних:** Всі APT групи, відстежувані різними вендорами

#### Інформація про групу (приклад: APT41):
- **📝 Опис діяльності** групи
- **🔗 Асоційовані назви** (Winnti Panda, Barium, та інші)
- **🚀 Кампанії** — проведені операції
- **⚙️ Техніки** — використовувані TTP
- **💻 Програмне забезпечення** — інструменти групи

**❌ Чого НЕ буде:**
- IP адреси
- Домени
- Хеші файлів
- Інші IOC (Indicators of Compromise)

**💡 Чому:** ATT&CK фокусується на поведінці, а не на індикаторах

### 💻 Програмне забезпечення (Software)

**База даних:** 760+ програмних засобів зловмисників

#### Приклад: Mimikatz
**Опис:** Credential dumper для отримання паролів Windows

**Інформація включає:**
- **📝 Функціональність** інструменту
- **⚙️ Техніки** — які TTP використовує
- **👥 Групи** — хто використовує цей інструмент
- **🚀 Кампанії** — в яких операціях застосовувався
- **📚 Посилання** — Mandiant, CrowdStrike, NSA тощо

### 🎯 Кампанії (Campaigns)

**Загальна кількість:** 24 кампанії

**⚠️ Важлива примітка:** Дуже мала частка від загальної кількості кібератак кваліфікується як "кампанія" за критеріями MITRE.

**Критерії кампанії:**
- Координована діяльність
- Множинні цілі
- Спільні TTP
- Специфічний часовий період
...
**1. Використовуйте Ctrl+F** для пошуку конкретних технік або груп

**2. Починайте з тактик** — зрозумійте "навіщо", потім переходьте до "як"

**3. Вивчайте зв'язки** — як техніки пов'язані з групами та кампаніями

### 📚 Рекомендований порядок вивчення:

```
1. Огляд матриці Enterprise
    ↓
2. Вибір цікавої тактики
    ↓  
3. Детальне вивчення 2-3 технік
    ↓
4. Перегляд груп, що використовують ці техніки
    ↓
5. Аналіз mitigations і detections
```

### 🎯 Фокус для початківців:

**Пріоритетні тактики для вивчення:**
1. **Initial Access** — як зловмисники потрапляють в систему
2. **Persistence** — як закріплюються
3. **Privilege Escalation** — як підвищують привілеї
4. **Defense Evasion** — як обходять захист

---

## Підготовка до кейс-стаді

### 🎓 Що ви вже знаєте:

✅ **Теоретичні основи** MITRE ATT&CK
✅ **Структуру веб-інтерфейсу** 
✅ **Взаємозв'язки між компонентами**
✅ **Практичну навігацію** по фреймворку

### 🚀 Наступний крок:

**Кейс-стаді** — застосування знань на практиці:
- Аналіз конкретного актора загроз
- Вивчення їх TTP
- Розробка стратегій виявлення та пом'якшення
...
**1. MITRE ATT&CK — це живий ресурс:**
- Регулярні оновлення
- Нові техніки та групи
- Актуальна інформація про загрози

**2. Фокус на поведінці, а не індикаторах:**
- TTP важливіші за IOC
- Поведінкові патерни важче змінити
- Довгострокова цінність для захисту
...
### 🎯 Готовність до практики:

Тепер ви готові застосувати отримані знання в реальному кейс-стаді, де проаналізуємо конкретного актора загроз та розробимо стратегії протидії його діяльності.

---

*Переходимо до першого кейс-стаді для застосування теоретичних знань на практиці!*

------------------------------------------------------------------------------------------------

# 36 Розділ 7: Еволюція та динаміка розвитку MITRE ATT&CK Framework

## Динамічна природа фреймворку

### 🔄 Постійне оновлення

MITRE ATT&CK **не є статичним** фреймворком — це **постійно еволюціонуюча** база знань, яка адаптується до мінливого ландшафту кіберзагроз.

#### Ключові характеристики:
- **⏰ Регулярність оновлень:** Приблизно кожні 6 місяців
- **🎯 Мета оновлень:** Включення найновіших TTP зловмисників
- **📊 Джерело інформації:** Дані від глобальної спільноти кібербезпеки

### 📅 Актуальна інформація про версії

**Станом на час запису:** Остання версія — жовтень 2023 року

**⚠️ Важлива примітка:** Перевіряйте наявність нових версій, оскільки оновлення відбуваються регулярно.

**🔗 Як перевірити поточну версію:**
- Офіційний сайт attack.mitre.org
- Розділ "Updates" або "Releases"
- GitHub репозиторій MITRE ATT&CK
...
#### 1. **Додавання нових технік**
- Виявлені нові методи атак
- Інноваційні підходи зловмисників
- Адаптація до нових технологій

#### 2. **Розширення підтехнік**
- Деталізація існуючих технік
- Специфічні варіанти реалізації
- Платформо-специфічні методи

#### 3. **Оновлення існуючої інформації**
- Покращення описів
- Додавання нових прикладів
- Оновлення посилань та джерел

### 🔸 Рідкісні зміни

#### **Нові тактики**
**❗ Важливо:** Додавання нових тактик відбувається **рідко**, оскільки:
- Тактики відображають фундаментальні цілі зловмисників
- Основні 14 тактик покривають переважну більшість сценаріїв
- Нові тактики з'являються лише при кардинальних змінах у кіберландшафті

---

## Джерела нових TTP

### 🌐 Глобальна спільнота кібербезпеки

#### Основні контрибютори:
- **🏢 Комерційні вендори безпеки** (CrowdStrike, Mandiant, Microsoft)
- **🏛️ Урядові агенції** (NSA, CISA, NCSC)
- **🎓 Дослідницькі організації** та університети
...
| Джерело | Приклади | Цінність |
|---------|----------|----------|
| **Incident Response** | Розслідування атак | Реальні TTP в дії |
| **Threat Hunting** | Проактивний пошук загроз | Нові варіанти техні |
| **Malware Analysis** | Аналіз зловмисного ПЗ | Технічні деталі |
| **CTI Research** | Розвідувальні звіти | Контекст та атрибуція |

---

## Практичне значення оновлень

### 🔍 Чому важливо слідкувати за оновленнями?

#### 1. **Актуальність захисту**
- Нові техніки = нові вектори атак
- Своєчасне оновлення детекцій
- Адаптація стратегій захисту

#### 2. **Конкурентна перевага**
- Випередження зловмисників
- Інноваційні підходи до безпеки
- Покращення security posture

#### 3. **Професійний розвиток**
- Розуміння нових трендів
- Розширення знань про TTP
- Підвищення експертизи

### 📚 Цінність нового контенту

**Нові техніки та підтехніки особливо цікаві тому, що:**

✅ **Відображають актуальні загрози**
- Методи, які активно використовуються
- Свіжі дані від спільноти безпеки

✅ **Показують еволюцію зловмисників**
- Адаптацію до нових технологій
- Відповіді на покращення захисту

✅ **Надають нові можливості для захисту**
- Ранні можливості для детекції
- Проактивне планування захисту

---

## Стратегії відстеження оновлень

### 🔔 Автоматичні сповіщення

#### **GitHub Watch**
- Відстеження репозиторію MITRE ATT&CK
- Сповіщення про нові релізи
- Детальні changelog'и

#### **RSS та Email підписки**
- Офіційні канали MITRE
- Security блоги та новини
- Vendor-специфічні оновлення

### 📅 Регулярний моніторинг

#### **Щомісячна перевірка:**
- Статус нових версій
- Аналіз змін в релевантних техніках
- Оцінка впливу на поточні детекції

#### **Поглиблений аналіз оновлень:**
```
Нова версія випущена
    ↓
Огляд release notes
    ↓
Аналіз нових технік
    ↓
Оцінка релевантності для організації
    ↓
Планування імплементації
    ↓
Оновлення детекцій та процедур
```
...
### 🏗️ Історичні тренди оновлень

#### **2019-2020: Cloud-native техніки**
- Додавання AWS, Azure, GCP специфічних методів
- Containerization та Kubernetes TTP
- Cloud privilege escalation

#### **2020-2021: Remote work адаптація**
- VPN та RDP специфічні техніки  
- Collaboration tools exploitation
- Home network targeting

#### **2022-2023: Supply chain та AI**
- Software supply chain attacks
- AI/ML targeting techniques
- DevOps pipeline exploitation

### 📊 Статистика росту:

| Рік | Загальна кількість технік | Нові додавання | Основні тренди |
|-----|---------------------------|----------------|----------------|
| **2020** | ~350 | 50+ | Cloud transformation |
| **2021** | ~400 | 45+ | Remote work security |
| **2022** | ~450 | 40+ | Supply chain focus |
| **2023** | ~500 | 35+ | AI і automation |

---

## Імплементація оновлень

### 🔄 Процес інтеграції нових TTP

#### **1. Аналіз релевантності**
```
Нова техніка виявлена
    ↓
Чи стосується нашого середовища?
    ↓
Чи використовують цю техніку наші adversaries?
    ↓
Який рівень ризику?
```

#### **2. Технічна імплементація**
- **Детекції:** Розробка правил SIEM/SOAR
- **Джерела даних:** Забезпечення необхідних логів  
- **Тестування:** Валідація детекцій
- **Документація:** Оновлення runbook'ів

#### **3. Навчання команди**
- Ознайомлення з новими TTP
- Практичні воркшопи
- Оновлення процедур incident response
...
- Automated TTP generation

#### **IoT та Edge Computing**
...
**Рекомендації:**
- Слідкуйте за emerging technologies
- Аналізуйте безпекові наслідки нових платформ
- Інвестуйте в continuous learning

---

## Практичні поради

### ✅ Best Practices для роботи з оновленнями

#### **1. Регулярність**
- Встановіть щомісячний календар перевірок
- Автоматизуйте сповіщення про оновлення

#### **2. Пріоритизація**
- Фокус на релевантних для організації TTP
- Врахування актуальних threat actor'ів

#### **3. Документування**
- Ведіть журнал змін у ваших детекціях
- Трекайте ефективність нових правил

#### **4. Командна робота**
- Розподіліть відповідальність за моніторинг
- Регулярно обговорюйте нові TTP на team meeting'ах

### 🚀 Інтеграція в Security Operations

**Як зробити MITRE ATT&CK живою частиною SOC:**

1. **Threat Intelligence:** Мапінг нових загроз на ATT&CK
2. **Incident Response:** Класифікація інцидентів за TTP
3. **Red Team:** Тестування нових техні в програмах
4. **Security Architecture:** Планування захисту на основі TTP
...
**1. Динамічність — ключова особливість MITRE ATT&CK**
- Фреймворк постійно еволюціонує
- Оновлення відображають реальний стан загроз

**2. Нові TTP — цінне джерело інформації**
- Свіжі дані від спільноти безпеки
- Можливості для проактивного захисту

**3. Систематичний підхід до оновлень критично важливий**
- Регулярний моніторинг
- Планована імплементація
- Командна співпраця

### 🎯 Дії для впровадження

**Негайні кроки:**
1. Налаштуйте сповіщення про оновлення MITRE ATT&CK
2. Проаналізуйте останні зміни у вашій галузі  
3. Оцініть поточні детекції на предмет актуальності

**Довгострокові ініціативи:**
1. Інтегруйте MITRE ATT&CK updates в Security Operations процеси
2. Розвивайте культуру continuous learning в команді
3. Будуйте partnerships з threat intelligence спільнотою

---

*Розуміння еволюційної природи MITRE ATT&CK є ключем до ефективного довгострокового використання цього фреймворку в вашій організації.*


------------------------------------------------------------------------------------------------------------------------------------------

# 38 Розділ 9: Threat Actor Profiling - APT41 та Winnti групи

## Початок розслідування

Після отримання intelligence про потенційну загрозу від APT41/Winnti, перший крок — **детальне вивчення противника**. Нам потрібно зрозуміти:
- 🎯 **Хто** вони і що робили раніше
- 🏢 **Які цілі** обирають
- ⚙️ **Які поведінкові патерни** демонструють

Саме цим ми займемося, використовуючи дані MITRE ATT&CK.

---

## APT41 - Детальний профіль

### 📋 Офіційне визначення MITRE ATT&CK

**APT41** — це група загроз, яку дослідники оцінюють як **китайську державно-спонсоровану шпигунську групу**, яка також проводить **фінансово мотивовані операції**.

### 🔍 Ключові характеристики:

#### **Хронологія діяльності:**
- **📅 Активна з:** 2012 року (як мінімум)
- **⏱️ Тривалість:** 12+ років безперервної діяльності
- **📈 Еволюція:** Постійне розширення можливостей

#### **Географічний масштаб:**
- **🌍 Охоплення:** 14+ країн світу
- **🎯 Основні регіони:** Азія, Європа, Північна Америка

#### **Галузеві цілі:**
- **🏥 Healthcare** — охорона здоров'я
- **📡 Telecom** — телекомунікації
- **💻 Technology** — технологічні компанії
- **🎮 Video Gaming** — ігрова індустрія

### 💰 Унікальна подвійна мотивація

**Особливість APT41:** Поєднання двох типів операцій

| Тип операції | Мотивація | Цілі | Методи |
|--------------|-----------|------|--------|
| **Державне шпигунство** | Геополітичні інтереси | Критична інфраструктура, урядові мережі | Довгострокова присутність, витік даних |
| **Фінансові операції** | Прибуток | Фінансові установи, gaming | Ransomware, крадіжка коштів |

---

## Winnti Group - Профіль партнера

### 📋 Офіційне визначення MITRE ATT&CK

**Winnti Group** — це **китайська група загроз**, активна з **2010 року** як мінімум.

### 🎮 Спеціалізація та еволюція:

#### **Початковий фокус:**
- **🎯 Primary target:** Ігрова індустрія
- **🔓 Методи:** Supply chain attacks на game developers
- **💻 Інструменти:** Custom backdoors та RATs

#### **Розширення діяльності:**
- **📈 Scope expansion:** Інші індустрії
- **🔗 Partnerships:** Тісна співпраця з APT41
- **⚙️ TTP sharing:** Обмін техніками та інструментами

### 🕸️ Мережа пов'язаних груп

**Winnti має зв'язки з:**
- **Axiom** — advanced persistent threat group
- **APT17** — китайська державна група  
- **Kajang** — регіональна cyber espionage група

**💡 Важливо:** Для нашого кейс-стаді фокусуємося на **APT41 та Winnti** як найбільш prominentних акторах.

---

## Аналіз кампаній

### 🚀 Кампанія 1: C0017 (Державні мережі США)

#### **📅 Хронологія:**
- **Початок:** Травень 2021
- **Завершення:** Лютий 2022
- **Тривалість:** 9 місяців активної діяльності

#### **🎯 Цілі та результати:**
- **Мішені:** 6 мереж уряду штатів США
- **Вектор атаки:** Exploitation вразливих веб-додатків
- **Результат:** Successful compromise та довготривала присутність

#### **⚡ Технічні особливості:**
```
Швидка адаптація
    ↓
Використання публічно розкритих 0-day vulnerabilities
    ↓  
Швидке впровадження нових експлойтів
    ↓
Initial access через Internet-facing applications
```

#### **🔍 Observed behaviors:**
- **⚡ Quick adaptation** до нових вразливостей
- **🛠️ Zero-day exploitation** capabilities
- **📊 PII exfiltration** — крадіжка персональних даних
- **🔄 Persistent access** навіть після remediation спроб

**💭 Аналіз:** Демонструє високий рівень ресурсів та доступ до advanced exploits.

### 🎪 Кампанія 2: Operation Cuckoo Bees

#### **📅 Хронологія:**
- **Початок:** 2019 рік (як мінімум)
- **Статус:** Ongoing campaign
- **Тривалість:** 5+ років безперервної активності

#### **🌍 Географічний масштаб:**
- **🏭 East Asia** — виробничі компанії
- **🇪🇺 Western Europe** — технологічні гіганти
- **🇺🇸 North America** — R&D центри

#### **🎯 Цілі операції:**
**Primary objectives (ймовірні):**
- **📋 Theft of proprietary information**
- **🔬 R&D documents** та дослідження
- **💻 Source code** критично важливих систем
- **📐 Blueprints** різноманітних технологій

#### **👥 Attribution:**
- **Winnti Group** — primary executor
- **APT41** — supporting operations  
- **Shared TTP** — спільні техніки та інструменти

**💡 Висновок:** Класична промислова cyber espionage з фокусом на intellectual property.

---

## TTP Analysis - Масштаб загрози

### 📊 Кількісний аналіз можливостей

#### **APT41 Arsenal:**
- **⚙️ Unique techniques:** 75+ методів
- **🔧 Sub-techniques:** Hundreds of variations
- **📈 Coverage:** Всі 14 тактик MITRE ATT&CK

#### **Winnti Capabilities:**
- **⚙️ Unique techniques:** 60+ методів
- **🎯 Specialized focus:** Gaming та technology sectors
- **🔗 Shared arsenal:** Overlap з APT41
...
CTI → Groups → APT41
    ↓
Attack Navigator Layers → Enterprise Layer → View
    ↓
Interactive ATT&CK Matrix с highlighted TTP
```

#### **Що показує Navigator:**

**✅ Повне покриття тактик:**
- Присутність у **всіх 14 тактиках**
- Множинні техніки на кожну тактику
- Extensive sub-technique variations

**📋 Масштаб arsenalu:**
```
Initial Access: 8+ techniques
Execution: 12+ techniques  
Persistence: 15+ techniques
Privilege Escalation: 10+ techniques
Defense Evasion: 20+ techniques
...і так далі для всіх тактик
```

---

## Виклики для захисників

### 😰 Масштаб проблеми

#### **Реальність цифр:**
- **📊 75+ techniques** для однієї групи
- **⚙️ Hundreds of sub-techniques** та варіацій
- **🛡️ Defence requirements:** Детекції для кожної техніки

#### **Ресурсні вимоги:**
```
1 Technique = 1-3 Detection Rules
    ↓
75 Techniques = 150-225 Rules  
    ↓
+ Testing + Tuning + Maintenance
    ↓  
= Substantial Security Operations overhead
```

### 💡 Практичний підхід

#### **Стратегія пріоритизації:**
**❌ Не можемо:** Покрити всі 75+ техніки одночасно
**✅ Можемо:** Розумно пріоритизувати critical techniques

#### **Критерії вибору техніки:**
1. **🚨 High Impact** — критично важливий для атаки
2. **📊 High Frequency** — часто використовується групою
3. **🔍 Detectability** — реально можливо виявити
4. **⚡ Speed to Implement** — швидко впровадити

### 🎯 Фокус кейс-стаді

**Для демонстрації підходу обираємо:**
- **1 ключову техніку** з high impact
- **1 підтехніку** з practical detectability

**Мета:** Показати **методологію** аналізу, яку можна застосувати до всього arsenalu.
...
#### **APT41/Winnti Threat Level: CRITICAL** 🔴

**Обґрунтування:**
- **🎯 Proven capabilities** — documented successful campaigns
- **⏱️ Longevity** — 10+ років безперервної діяльності  
- **🌍 Global reach** — worldwide targeting capability
- **⚡ Rapid adaptation** — quick adoption нових exploits
- **🔧 Extensive arsenal** — повне покриття ATT&CK matrix

#### **Специфічні ризики для організацій:**

| Сектор | Ризик | Rationale |
|--------|-------|-----------|
| **Technology** | 🔴 CRITICAL | Primary target, IP theft |
| **Gaming** | 🔴 CRITICAL | Winnti specialization |
| **Healthcare** | 🟠 HIGH | APT41 documented targets |
| **Government** | 🔴 CRITICAL | C0017 campaign evidence |
| **Manufacturing** | 🟠 HIGH | Cuckoo Bees targeting |

### 🚀 Стратегічні висновки

#### **Для Security Operations:**
1. **⚡ Urgency justified** — загроза real та immediate
2. **📊 Comprehensive approach needed** — partial coverage недостатня
3. **🔄 Continuous monitoring required** — grupos continuously evolve
4. **👥 Team coordination critical** — масштаб перевищує можливості однієї людини

#### **Для Management:**
1. **💰 Resource allocation** — substantial investment needed
2. **⏰ Timeline expectations** — months, not weeks для повного coverage
3. **🎯 Risk prioritization** — focus на most critical techniques first
4. **📈 ROI measurement** — metrics для tracking progress

---

## Наступні кроки

### 🔍 Deep Dive в конкретні TTP

**Готові до детального аналізу:**
- Вибрали 1-2 key techniques
- Розуміємо контекст та мотивацію груп
- Маємо realistic expectations щодо scope роботи

### 📋 План детального аналізу:

```
Крок 1: Technique Selection
    ↓
Крок 2: Technical Deep Dive  
    ↓
Крок 3: Detection Engineering
    ↓
Крок 4: Mitigation Strategy
    ↓
Крок 5: Implementation Planning
```

**🎯 Мета:** Створити reusable methodology для аналізу будь-якої техніки з APT41/Winnti arsenalu.
...
# 41  Розділ: Піраміда болю та важливість фокусу на поведінці

## Заключення кейсу: Критична важливість моніторингу поведінки

### Ключовий принцип
**Надзвичайно важливо спостерігати та моніторити поведінку** і **захищатися від поведінки замість окремих інструментів**.

Цей принцип можна ідеально проілюструвати, повернувшись до **Піраміди болю**.

---

# Практичний приклад: Аналіз через Піраміду болю

## Контекст: Техніка з використанням Mimikatz

Використовуючи приклад техніки та підтехніки, де **противники використовували Mimikatz**, розглянемо кожен рівень піраміди:

### 1. Hash Values (Хеш-значення) - ТРИВІАЛЬНИЙ рівень

**Складність для противника:** Абсолютно тривіальна

**Як легко змінити:**
- **Просто додай один символ** → отримаєш інший хеш
- Миттєва зміна без зусиль

**Висновок:** Фокус на хешах неефективний для захисту

### 2. IP Addresses (IP-адреси) - ЛЕГКИЙ рівень

**Складність для противника:** Легка

**Приклад APT41:**
- **Зміна IP-адрес** для кампанії APT41 є простою
- Можуть легко це зробити без особливих зусиль

**Висновок:** IP-based блокування легко обходиться

### 3. Domain Names (Доменні імена) - ЛЕГКИЙ рівень

**Складність для противника:** Легка

**Процес:**
- **Просто налаштувати нові домени**
- Це не складно для організованих груп

**Висновок:** Блокування доменів має обмежену ефективність

### 4. Network/Host Artifacts (Мережеві/хостові артефакти) - ПОМІРНИЙ рівень

**Складність для противника:** Раздратовуюча, але виконувана

**Характеристика:**
- **Так, це дратує**, але все ще можна зробити
- Потребує більше зусиль, але не критично

### 5. Tools (Інструменти) - СКЛАДНИЙ рівень

**Складність для противника:** Виклик

**Щодо Mimikatz:**
- **Зміна Mimikatz є викликом**
- Можна зробити, **також використовують інші інструменти**
- **Все ще залишається викликом** для противників

**Примітка:** Можуть використовувати альтернативні інструменти, але це вимагає більше ресурсів

### 6. TTPs (Tactics, Techniques, Procedures) - ДУЖЕ СКЛАДНИЙ рівень

**Складність для противника:** Великий виклик

**Чому це найскладніше:**

#### Технічна складність:
**Побудувати інший інструмент**, що виконує те ж саме, що й Mimikatz:
- **По-перше, складно** з технічної точки зору
- **По-друге, потрібна зміна техніки та підтехніки**

#### Наші захисні переваги:
**З перспективи техніки та підтехніки:**
- **Багато заходів протидії та виявлення** НЕ зосереджені на Mimikatz
- **Замість цього фокусуються на поведінці**
- **Не має значення, який інструмент вони використовують** - ми все одно виявимо

---

# Сила фокусу на поведінці

## Чому TTPs є найефективнішою точкою захисту

### 1. Незалежність від інструментів
**"Не має значення, який інструмент вони використовують, ми все одно виявимо"**

### 2. Подвійна складність для противника
Для зміни TTPs противники повинні:
- **Побудувати окремий інструмент**, що робить те ж саме, що й Mimikatz
- **Використати іншу техніку та підтехніку**

### 3. Наші існуючі захисти
**Ми вже маємо заходи протидії та виявлення** для цієї техніки та підтехніки, що фокусуються на:
- **Дампінг облікових даних з LSASS**
- **Поведінкові патерни**, а не конкретні інструменти

## Практичний приклад: Техніка дампінгу облікових даних

### Наш підхід:
- **Моніторимо поведінку:** спроби доступу до LSASS процесу
- **Виявляємо патерни:** незвичайну активність з пам'яттю
- **Не залежимо від інструменту:** Mimikatz, WCE, або кастомний інструмент

### Результат:
**Будь-який інструмент**, що намагається дампити облікові дані, буде виявлений нашими **поведінково-орієнтованими** засобами захисту.

---

# Фундаментальні принципи Threat-Informed Defense

## 1. Знання TTPs противника
**"Ми знаємо, які TTPs використовують погані хлопці та дівчата"**

### Переваги:
- **Проактивний підхід** до захисту
- **Прогнозування** методів атак
- **Підготовленість** до відомих технік

## 2. Фокус на поведінці замість інструментів
**"Надзвичайно важливо зосереджуватися на поведінці замість інструментів"**

### Причини критичної важливості:
- **Інструменти змінюються** - поведінка залишається
- **Економія ресурсів** на безперервній адаптації до нових інструментів
- **Вища ефективність** виявлення

### Практична реалізація:
- Моніторинг **системної поведінки**
- Виявлення **аномальних паттернів**
- Фокус на **мету дій**, а не засоби

---

# MITRE ATT&CK: Суть фреймворку

## Філософія фреймворку
**"Це те, про що MITRE ATT&CK дійсно"**

### Основні принципи:
1. **Threat-informed defense** - оборона, інформована про загрози
2. **Поведінково-орієнтований підхід** до безпеки
3. **Фокус на TTPs** замість індикаторів компрометації

## Практичне застосування

### Стратегія захисту:
- **Мапінг поведінки** до техник MITRE ATT&CK
- **Розробка детекцій** на основі поведінкових паттернів
- **Тестування захистів** проти реальних TTPs

### Переваги підходу:
- **Довготривала ефективність** - не застаріває з новими інструментами
- **Економічна ефективність** - менше потреби в постійних оновленнях
- **Стратегічна перевага** - фокус на фундаментальній поведінці

---

# Ключові висновки

## 1. Ієрархія ефективності захисту
**Піраміда болю показує:**
- **Індикатори (хеші, IP, домени)** - легко обходяться
- **Інструменти** - середня складність зміни
- **TTPs** - найскладніше для противника змінити

## 2. Стратегічний фокус
**Найефективніший захист:**
- **Моніторинг поведінки** замість артефактів
- **Виявлення намірів** замість інструментів
- **TTPs-орієнтований** підхід до безпеки

## 3. Довгострокова стійкість
**Поведінково-орієнтовані захисти:**
- **Залишаються актуальними** при зміні інструментів
- **Адаптуються** до нових варіантів старих техник
- **Максимізують ROI** інвестицій у безпеку

## 4. MITRE ATT&CK як інструмент
**Фреймворк допомагає:**
- **Структурувати** розуміння поведінки противника
- **Стандартизувати** підходи до захисту
- **Вимірювати** ефективність захисних заходів

**Головне послання:** Успішна кібербезпека базується на **розумінні та протидії поведінці противника**, а не гонитві за окремими інструментами чи індикаторами. Це фундаментальна філософія сучасної threat-informed defense.


------------------------------------------

# 42 Розділ: Стандартизована комунікація через MITRE ATT&CK

## Одна з найбільших переваг операціоналізації MITRE ATT&CK

### Ключова перевага
**Впровадження стандартизованої комунікації** по всьому вашому SOC та CTI персоналу.

---

# Типова комунікація в командах: Проблемний приклад

## Звичайний потік комунікації

Розглянемо **типовий потік комунікації** в цих командах:

### Діалог між аналітиками:

**Перший аналітик:**
> "Я бачу цю команду в тексті SDK URL як двокрапка. Двокрапка логін паролі"

**Другий аналітик:**
> "Так, це Mimikatz, я здогадуюсь"
> *(тому що він може розпізнати патерни, які дуже популярні)*

**Третій аналітик:**
> "Гаразд, давайте напишемо аналітичне правило для цього рядка або випадку використання, як би ви не називали це, просто виявлення в вашому SIEM або EDR рішенні"

## Критичне запитання
**Чи це дійсно гарна поведінка з точки зору комунікації?**

### Аналіз проблем:
- **Так, вони висловлюють те, що відбувається** - це правда
- **Але це можна зробити краще** - безперечно
- Фокус на **синтаксисі інструменту** замість поведінки

---

# Правильна комунікація: Поведінково-орієнтований підхід

## Як слід комунікувати правильно

### Покращений діалог:

**Перший аналітик:**
> "Це насправді поширена поведінка, яку ми бачимо серед груп. Фактична поведінка, яку ми спостерігаємо, полягає в тому, що інструмент, який би він не був, **дампить облікові дані з пам'яті LSASS**"

**Третій аналітик:**
> "Гей, ми повинні **моніторити поведінку процесів**, які отримують доступ до виконуваного файлу LSASS"

## Порівняння підходів

### Який спосіб комунікації кращий?
**Очевидно, той, що фокусується на поведінці замість синтаксису окремих інструментів, набагато кращий.**

---

# Причини переваги поведінково-орієнтованої комунікації

## 1. Стандартизована комунікація

### Переваги:
- **Єдина мова** для всієї команди
- **Зрозумілість** для всіх рівнів експертизи
- **Послідовність** у документації та звітності

## 2. Кращі детекції

### Результат стандартизації:
**Призводить до написання детекцій**, що фокусуються на:
- **Поведінці противників** замість окремих інструментів
- **Сталих паттернах** атакуючих
- **Універсальних індикаторах** компрометації

## 3. Правильний фокус зусиль безпеки

### Стратегічний підхід:
- **Зосередження зусиль** на поведінці противників
- **Не боротьба** з окремими інструментами
- **Довгострокова ефективність** захисних заходів

---

# Фундаментальний принцип курсу

## Червона лінія через весь курс

**Основне правило:** 
> **Ніколи, ніколи не фокусуйтеся** на спробах захиститися від певного інструменту або певного програмного забезпечення.

### Замість цього:
**Ви повинні зосереджуватися на комунікації та захисті таким чином**, що ви завжди робите це з **фокусом на поведінці**.

---

# Переваги операціоналізації MITRE ATT&CK

## Зміна перспективи

### Від чого відходимо:
- **Фокус на дрібних деталях** (хеші, рядки, команди)
- **Реактивний підхід** до конкретних інструментів
- **Фрагментована комунікація** між аналітиками

### До чого переходимо:
- **Підхід, що фокусується на тому, як поводяться противники**
- **Проактивне розуміння** TTPs
- **Стандартизована термінологія**

## Практичні переваги

### 1. Сталість (Sustainability)
**Набагато більш сталий** спосіб роботи в SOC:
- **Не потребує постійного оновлення** під кожен новий інструмент
- **Фокус на фундаментальній поведінці**, що змінюється рідко

### 2. Масштабованість (Scalability)
**Набагато більш масштабований** для роботи в SOC:
- **Універсальні правила детекції**
- **Ефективне використання** ресурсів аналітиків
- **Швидша адаптація** до нових варіантів відомих техник

### 3. Ефективність
**Швидке усвідомлення переходу**:
- Від **дрібних деталей** до **стратегічного розуміння**
- Від **реактивного** до **проактивного** підходу
- Від **інструмент-центричного** до **поведінково-центричного** мислення

---

# Практична імплементація

## Зміни в SOC процесах

### 1. Структура комунікації
**Стандартизований словник:**
- Використання **MITRE ATT&CK техник** як загальної мови
- **Послідовні описи** інцидентів
- **Зрозумілі ескалації** між рівнями

### 2. Розробка детекцій
**Поведінково-орієнтовані правила:**
- **Моніторинг системної поведінки** замість сигнатур
- **Виявлення аномалій** в легітимних процесах
- **Фокус на мету** дій противника

### 3. Threat Intelligence
**Стратегічне планування:**
- **Мапінг актуальних загроз** до ATT&CK матриці
- **Пріоритизація захисних заходів** на основі реальних TTPs
- **Проактивне планування** захисту
...
### Еволюція SOC:
1. **Реактивна відповідь** → **Проактивна готовність**
2. **Точкові рішення** → **Системний підхід**
3. **Технічні детекції** → **Стратегічне розуміння**

### Розвиток персоналу:
- **Глибше розуміння** механізмів атак
- **Краще прогнозування** поведінки противників
- **Ефективніша колаборація** між командами

## Бізнес-value

### ROI від імплементації:
- **Зменшення false positives** через кращі детекції
- **Швидша ідентифікація** реальних загроз
- **Економія ресурсів** на підтримці та оновленнях
- **Покращена готовність** до нових типів атак
...
**1. Стандартизація комунікації**
- MITRE ATT&CK надає **загальну мову** для SOC та CTI команд

**2. Фокус на поведінці**
- **Поведінково-орієнтований підхід** більш ефективний за інструмент-орієнтований

**3. Довгострокова сталість**
- **Масштабованість та сталість** операцій SOC

**4. Стратегічна перевага**
- **Перехід від тактичного до стратегічного** мислення в кібербезпеці

**Головне послання:** Операціоналізація MITRE ATT&CK **трансформує спосіб роботи** команд безпеки, переводячи їх від реактивного реагування на окремі інструменти до **проактивного розуміння та протидії поведінці противників**. Це забезпечує **більш ефективну, масштабовану та сталу** систему кібербезпеки.
